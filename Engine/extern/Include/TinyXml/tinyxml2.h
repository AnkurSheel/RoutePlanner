...
namespace tinyxml2
{
  ...
  */
  ...
  public:
    ...
    static char* SkipWhiteSpace(char* p) { return const_cast<char*>(SkipWhiteSpace(const_cast<const char*>(p))); }
  ...
  */
  ...
  public:
    ...
    XMLDeclaration* ToDeclaration() { return ((_node == 0) ? 0 : _node->ToDeclaration()); }
  private:
    XMLNode* _node;
  };
  ...
  */
  ...
  public:
    ...
    const XMLElement* ToElement() const { return ((_node == 0) ? 0 : _node->ToElement()); }
    const XMLText* ToText() const { return ((_node == 0) ? 0 : _node->ToText()); }
    const XMLUnknown* ToUnknown() const { return ((_node == 0) ? 0 : _node->ToUnknown()); }
    const XMLDeclaration* ToDeclaration() const { return ((_node == 0) ? 0 : _node->ToDeclaration()); }
  private:
    const XMLNode* _node;
  };
